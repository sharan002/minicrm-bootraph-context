...
const Header = () => {
  ...
  const handleLogout = async () => {
    try {
      await axios.post('http://localhost:5030/api/logout', {}, { withCredentials: true });
    ...
    <header className="bg-white shadow-sm border-bottom">
      <div className="px-3">
        <div className="d-flex align-items-center justify-content-between py-2 position-relative">
          ...
          {/* Right: Search + Notifications + Add Lead + Logout */}
          <div className="d-flex align-items-center position-relative">
            ...
            {/* Add Lead */}
            <button onClick={() => setShowModal(true)} className="btn btn-primary me-2">
